...
public class SwitchButton extends CompoundButton {
    ...
    private float minChangeDistanceScale = 0.0f;   //有效距离比例，例如按钮宽度为100，比例为0.3，那么只有当滑动距离大于等于(100*0.3)才会切换状态，否则就回滚
     ...
     public void setChecked(boolean checked) {
        ...
        if(changed){
            if(getWidth() > 0 && switchScroller != null){   //如果已经绘制完成
            	...
            	setSlideX(isChecked() ? tempMaxSlideX : tempMinSlideX);
            }
        }
    }
    ...
    private class SwitchScroller implements Runnable {
        ...
        public void startScroll(boolean checked){
        	...
        	scroller.startScroll(tempSlideX, 0, (checked? tempMaxSlideX : tempMinSlideX) - tempSlideX, 0, duration);
            post(this);
			mcontext.sendBroadcast(new Intent("refreshwifibutton"));
