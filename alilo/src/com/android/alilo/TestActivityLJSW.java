    ...
    OnTouchListener touchListener = new OnTouchListener() {
		...
		public boolean onTouch(View v, MotionEvent event) {
				...
				case R.id.imageViewage1:
					onTouchChange("imageViewage1", event.getAction());  //20170103_wangjx_添加二级菜单返回功能
					break;
				case R.id.imageViewage2:
					onTouchChange("imageViewage2", event.getAction());  //20170103_wangjx_添加二级菜单返回功能
					break;
				case R.id.imageViewage3:
					onTouchChange("imageViewage3", event.getAction());  //20170103_wangjx_添加二级菜单返回功能
					break;
				case R.id.back:
					onTouchChange("back", event.getAction());  //20170103_wangjx_添加二级菜单返回功能
					finish();
					break;
				case R.id.imageViewljswjs:
					onTouchChange("imageViewljswjs", event.getAction());  //20170103_wangjx_添加二级菜单九宫格点击事件
					break;
				default:
					break;
				}
	...
	void onTouchChange(String methodName, int eventAction) {
		if ("imageViewage1".equals(methodName)) {
			if (eventAction == MotionEvent.ACTION_DOWN) {
				...
				imageViewage1.setImageResource(R.drawable.age1_after); //20170103_wangjx_增加点击事件
			...
			if (eventAction == MotionEvent.ACTION_DOWN) {
				...
				imageViewage2.setImageResource(R.drawable.age2_after);//20170103_wangjx_增加点击事件
			...
			if (eventAction == MotionEvent.ACTION_DOWN) {
				...
				imageViewage3.setImageResource(R.drawable.age3_after); //20170103_wangjx_增加点击事件
				imageViewage1.setImageResource(R.drawable.age1);
				imageViewage2.setImageResource(R.drawable.age2);
	        }else if (eventAction == MotionEvent.ACTION_UP){
			}
